...
import { isPropertySaved, toggleSavedProperty } from "../utils/savedPropertiesStore";
        ...
        <div className="page-container details-page">
            ...
            <div className="details-actions">
                <button className="secondary-btn"
                    onClick={() => {
                        console.log("View Reviews clicked", property); navigate(`/property/${property.id}/reviews`, { state: { property } });
                    }}
                >
                    View Reviews
                </button>
